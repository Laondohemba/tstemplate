            ...
            <div class="container mx-auto bg-gray-50 py-4 min-h-screen">
                ...
                <div class="mb-6 px-4">
                    <div class="flex justify-between items-center">
                        <div>
                            <h1 class="text-2xl md:text-3xl font-bold text-gray-900">Explore Products</h1>
                            <p class="text-gray-600 mt-2">Discover agricultural products from verified suppliers across Nigeria</p>
                        </div>
                    ...
                    @else
                        ...
                        <div class="text-center py-16">
                            ...
                            <p class="text-gray-600 mb-8 max-w-md mx-auto">
                                No products match your current filters. Try adjusting your search criteria or explore different categories.
                            </p>
