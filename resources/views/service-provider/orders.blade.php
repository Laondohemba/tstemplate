            ...
            <div class="container mx-auto bg-gray-50 py-4 min-h-screen">
                ...
                <div class="mb-6 px-4">
                    <div class="flex justify-between items-center">
                        <div>
                            <h1 class="text-2xl md:text-3xl font-bold text-gray-900">Service Orders</h1>
                            <p class="text-gray-600 mt-2">Manage orders for your services</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-sm text-gray-600">
                                                    @if($order->product)
                                                        ...
                                                        <p>Category: {{ $order->product->category->category }}</p>
                                                    @else
                                                        <p>Service Order</p>
                                                    @endif
                    ...
                    @else
                        ...
                        <div class="text-center py-16">
                            ...
                            <h3 class="text-2xl font-bold text-gray-900 mb-4">No Service Orders Yet</h3>
                            <p class="text-gray-600 mb-8 max-w-md mx-auto">
                                You haven't received any service orders yet. Once customers start ordering your services, they'll appear here.
                            </p>
...
function updateOrderStatus(orderId, status) {
    if (confirm(`Are you sure you want to update this order status to ${status}?`)) {
        fetch(`/dashboard/service-provider/orders/${orderId}/status`, {
            method: 'PATCH',
            headers: {
