    ...
    <div class="h-full px-3 py-4 overflow-y-auto">
        ...
        <div class="flex flex-col justify-between h-[88%] md:h-[85%] gap-6">
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('service-provider.dashboard') }}"
                        class="flex items-center p-3 rounded-lg {{ request()->routeIs('service-provider.dashboard') ? 'active-menu-item' : '' }} group">
                ...
                <li>
                    <a href="{{ route('service-provider.requests') }}"
                        class="flex items-center p-3 rounded-lg hover:bg-gray-700 {{ request()->routeIs('service-provider.requests') ? 'active-menu-item' : '' }} group">
                        <svg class="w-5 h-5 text-gray-500 group-hover:text-gray-900" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <!-- Orders -->
                <li>
                    <a href="{{ route('service-provider.orders') }}"
                        class="flex items-center p-3 rounded-lg hover:bg-gray-700 {{ request()->routeIs('service-provider.orders') ? 'active-menu-item' : '' }} group">
                        <svg class="w-5 h-5 text-gray-500 group-hover:text-gray-900" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
